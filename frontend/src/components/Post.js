            ...
            <Container>
                ...
                <Content>
                    ...
                    <Actions>
                        ...
                        <Like wallet={wallet} lensHub={lensHub} profileId={profileId} publicationId={post.id} stats={post.stats} setToastMsg={setToastMsg} liked={post.reaction === 'UPVOTE' || post.mirrorOf?.reaction === 'UPVOTE'} />
